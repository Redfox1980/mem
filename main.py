...
class StartScreen(Screen):
    def __init__(self, **kwargs):
        ...
        range_layout = BoxLayout(size_hint=(1, 0.2), spacing=10)
        ...
        self.time_label = Label(text="Countdown-Zeit pro Begriff", font_size=24, color=text_color, size_hint=(1, 0.1))
        self.layout.add_widget(self.time_label)

        self.time_input = TextInput(text="2", input_filter='int', font_size=24, size_hint=(1, 0.2),
                                    halign='center', multiline=False)
